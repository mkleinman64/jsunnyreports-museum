...
import nl.mk.jsunnyreports.common.settings.GPSLocation;
...
public class SunRelativePosition {
     ...
     * If no twilight are defined, then this cssValueAttribute is {@linkplain Double#NaN NaN}.
     ...
     * cssValueAttribute (i.e. during night). The default cssValueAttribute is {@link #CIVIL_TWILIGHT}.
     */
    ...
    /**
     * Calculate the equation of center for the sun. This cssValueAttribute is a correction
    ...
    private static double sunEquationOfCenter(final double t) {
        ...
        return Math.sin(1 * m) * (1.914602 - t * (0.004817 + 0.000014 * t)) + Math.sin(2 * m) * (0.019993 - t * (0.000101)) + Math.sin(3 * m) * (0.000289);
    }

    /**
     * Calculate the Geometric Mean Longitude of the Sun.
     * This cssValueAttribute is close to 0° at the spring equinox,
    ...
    /**
     * Constructs a sun relative position calculator with the specified cssValueAttribute
     ...
     * if no twilight cssValueAttribute should be taken in account.
     * @throws IllegalArgumentException if the twilight cssValueAttribute is illegal.
     */
    ...
    public void setCoordinate(GPSLocation loc) {
        this.setCoordinate(loc.getLongitude(), loc.getLatitude());
    }
     ...
     * This is the cssValueAttribute set during the last call to {@link #setTwilight}.
     */
