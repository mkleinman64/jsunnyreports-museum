 ...
 * @since: 0.0.1
 */
public final class SunnyDataControlXLSInverter extends BaseInverter {
    private static final Logger log = Logger.getLogger(SunnyDataControlXLSInverter.class);

    public SunnyDataControlXLSInverter(Settings s, String M_InverterName, String M_WattPeak, String M_kWhkWp, int M_InverterType, String M_InputDirectory, String M_BarColor, String M_LineColor, String M_FromDate, String O_CompareLineColor,
