...
public final class SunnyWebboxInverter extends BaseInverter {
    private static final Logger log = Logger.getLogger(SunnyWebboxInverter.class);

    public SunnyWebboxInverter(Settings s, String M_InverterName, String M_WattPeak, String M_kWhkWp, int M_InverterType, String M_InputDirectory, String M_BarColor, String M_LineColor, String M_FromDate, String O_CompareLineColor,
