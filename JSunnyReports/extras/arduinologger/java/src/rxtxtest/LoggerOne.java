...
public class LoggerOne {
    ...
    public LoggerOne(Settings settings) {
       this.settings = settings;
       this.max_watt = settings.getPropertyFloat("logger1.maxwatt");
       this.dirLocation = settings.getProperty("logger1.outputlocation");
       this.PULSE_KWH = settings.getPropertyInt("logger1.pulses");
       if ( PULSE_KWH == 0 ) {
          PULSE_KWH = 2000;
       }
    }
  ...
  public float getWH_PULSE() {
    ...
    public void doLog(Calendar currentPulse) {
        ...
        if ( insertlog ) {
          ...
          System.out.println( "Logger1 : " + toWrite );
