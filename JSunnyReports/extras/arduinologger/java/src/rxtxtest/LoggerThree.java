...
public class LoggerThree {

 
    public LoggerThree(Settings settings) {
       this.settings = settings;
       this.max_watt = settings.getPropertyFloat("logger3.maxwatt");
       this.dirLocation = settings.getProperty("logger3.outputlocation");
       this.PULSE_KWH = settings.getPropertyInt("logger3.pulses");
       if ( PULSE_KWH == 0 ) {
          PULSE_KWH = 2000;
       }
   ...
   public float getWH_PULSE() {
    ...
    public void doLog(Calendar currentPulse) {
        ...
        if ( insertlog ) {
          ...
          System.out.println( "Logger3 : " + toWrite );
